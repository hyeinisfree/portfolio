...
import { FaGem, FaJava, FaReact } from "react-icons/fa";
  ...
  Language: [
    {
      ...
      color: "#7F52FF",
      details: [
        "실무에서 Kotlin 기반의 백엔드 서비스를 개발·운영했습니다.",
        "data class, sealed class, 확장 함수, null 안정성 등 Kotlin의 언어 특성을 활용해 안전하고 간결한 코드를 작성할 수 있습니다.",
        "Spring Boot·Spring Batch와 결합한 Kotlin 백엔드 개발에 익숙합니다.",
      ],
    },
    {
      name: "Java",
      ...
      color: "#007396",
      details: [
        "객체지향 설계 원칙(OOP, SOLID 등)에 대한 깊은 이해를 바탕으로 코드를 작성할 수 있습니다.",
    ...
    },
    {
      ...
      color: "#CC342D",
      details: [
        "2년간 실무에서 Ruby on Rails로 서비스를 개발했으며, Ruby 문법에 익숙합니다.",
    ...
    },
    {
      ...
      color: "#2D79C8",
      details: [
        "Next.js 등에서 타입 선언을 작성한 경험이 있습니다.",
        "interface와 type의 기본적인 차이를 이해하고, 상황에 따라 선택해 사용할 수 있습니다.",
        "실전에서 발생하는 타입 오류를 분석하고 해결할 수 있습니다.",
      ],
    },
  ],
  "Backend Framework": [
    {
      ...
      color: "#6DB33F",
      details: [
        "실무에서 Kotlin/Spring Boot 기반의 멀티 모듈 백엔드를 개발·운영했습니다.",
        "Spring Boot 기반의 RESTful API 서버를 설계하고 구현한 다양한 프로젝트 경험이 있습니다.",
        "도메인 별로 모듈을 분리한 Gradle 멀티 모듈 아키텍처를 직접 설계하고 적용한 경험이 있습니다.",
    ...
    },
    {
      ...
      color: "#6DB33F",
      details: [
        "OpenSearch 색인 Job(전체/재색인 + catchup step + 증분 색인), 상품 일괄 등록 배치, 메타데이터 정리 Job 등을 실무에서 구현했습니다.",
        "Job·Step·Reader·Processor·Writer 구조와 청크 기반 처리를 이해하고 활용할 수 있습니다.",
        "재색인 중 들어온 변경분을 따라잡는 catchup step을 설계하는 등 배치 일관성을 고려한 경험이 있습니다.",
      ],
    },
    {
      name: "Ruby on Rails",
  ...
  "Database / Search": [
    ...
    },
    {
      ...
      details: [
        ...
        "pub/sub 기능을 사용해 채팅 기능을 구현한 경험이 있습니다.",
        "Spring Boot와 RedisTemplate을 활용한 연동 설정 및 데이터 조작을 수행할 수 있습니다.",
      ],
    },
    {
      name: "OpenSearch",
      ...
      color: "#005EB8",
      details: [
        "검색 엔진을 OpenSearch로 0→1 도입한 경험이 있습니다. helm chart로 인프라(ingress·auth·dashboards)를 구성하고, 동의어/사용자 사전을 S3와 동기화하는 sidecar 패턴을 운영에 적용했습니다.",
        "전체/재색인 + catchup step + 증분 색인 Job을 구현하고, 상품·브랜드 다중 인덱스 운영 패턴을 확립했습니다.",
        "검색 API에 Circuit Breaker + DB fallback 패턴(팀에서 도입한 패턴)을 브랜드 검색까지 확장 적용했습니다.",
        "Nori analyzer와 동의어/사용자 사전 기반의 한국어 검색 정확도 개선을 학습하며 적용했습니다.",
        "Elasticsearch 기반 검색도 다뤄, Index·Query DSL·Analyzer 등 검색 엔진 공통 개념에 익숙합니다.",
      ],
    },
  ],
  "Frontend Framework": [
  ...
  "Infra / DevOps": [
    {
      ...
      color: "#FF9900",
      details: [
        "실무에서 EKS, SQS, S3, CloudFront 등을 인프라로 운영했습니다.",
    ...
    },
    {
      ...
      color: "#326CE5",
      details: [
        "EKS 기반 환경에서 신규 microservice와 검색 인프라를 helm chart로 배포·운영한 경험이 있습니다.",
        "Pod·Service·Ingress·ServiceAccount 등 기본 리소스와 배포 흐름을 이해하고 다룰 수 있습니다.",
        "클러스터 자체 구축은 팀이 담당했고, 본인은 워크로드와 차트 영역을 맡아 운영했습니다.",
      ],
    },
    {
      name: "Helm",
      ...
      color: "#0F1689",
      details: [
        "신규 microservice·인프라의 helm chart를 0→1로 설계한 경험이 있습니다.",
        "values 계층, template, ingress·auth 설정 등을 작성하고 운영한 경험이 있습니다.",
      ],
    },
    {
      name: "ArgoCD",
      ...
      color: "#EF7B4D",
      details: [
        "EKS + ArgoCD 기반 GitOps 환경에서 매니페스트 변경(설정·health check·ingress 등)을 통해 배포를 운영한 경험이 있습니다.",
        "Git을 단일 소스로 두는 GitOps 배포 흐름을 이해하고 다룰 수 있습니다.",
      ],
    },
    {
      name: "Docker",
    ...
    },
    {
      ...
      color: "#7B42BC",
      details: [
        "실무에서 검색 엔진 도입·CloudFront 설정 등 인프라 변경을 Terraform 코드로 반영한 경험이 있습니다.",
        "VPC, EC2, RDS, S3, IAM, Route 53 등을 모듈화하여 효율적으로 배포/수정할 수 있습니다.",
        "Plan → Apply → Destroy 흐름과 상태 파일 관리(tfstate)에 대한 기본적인 이해를 바탕으로 인프라를 운영할 수 있습니다.",
      ],
    },
    {
      name: "Jenkins",
    ...
    },
    {
      ...
      color: "#F46800",
      details: [
        "기존 Grafana/Loki/Alloy stack 위에서 MDC 키 표준화·UUID 추가로 Slack alert → Loki 쿼리 추적 흐름을 정비했습니다.",
        "Alloy stage.match selector, app-log/access-log tenant 분리 등으로 로그 검색 효율을 개선했습니다.",
        "Loki 쿼리 기반으로 운영 에러를 추적하고 디버깅하는 흐름에 익숙합니다.",
      ],
    },
  ],
  Tools: [
    ...
    },
    {
      ...
      color: "#CC0101",
      details: [
        "Flyway를 사용해 데이터베이스 버전 관리를 수행했으며, 여러 프로젝트에서 마이그레이션 전략을 적용한 경험이 있습니다.",
